...
2.2. Set one of them with a HTTP header `X-OffTempo-Pool: B`
4. Start attack for both of the intruder requests
5. Go to Offtempo tab and just wait, click Run after enough samples collected
